    ...
    public function run(): void
    {
        ...
        $this->addBatch(
            ...
            posts: [
                $this->post(title: 'Pengenalan Algoritma',
                    ...
                    content: '<p>Algoritma adalah langkah-langkah logis yang sistematis untuk menyelesaikan suatu permasalahan...</p>',
                    min_score: null,
                    type: 'material'),
                ...
                $this->post(title: 'Struktur Data Dasar',
                    ...
                    content: '<p>Struktur data dasar seperti array dan linked list digunakan untuk menyimpan dan mengelola data...</p>',
                    min_score: null,
                    type: 'material'),

                $this->post(title: 'Latihan Implementasi Array dan Linked List',
                    description: '<p>Tugas ini meminta peserta mengimplementasikan array dan linked list...</p>',
                    content: '<p>Peserta diminta membuat program yang menggunakan array dan linked list...</p>',
                    min_score: 70,
                    type: 'submission'),

                $this->post(title: 'Stack dan Queue',
                    description: '<p>Menjelaskan konsep stack dan queue serta penerapannya dalam pemrograman.</p>',
                    content: '<p>Stack (tumpukan) menggunakan prinsip LIFO (Last In, First Out)...</p>',
                    min_score: null,
                    type: 'material'),

                $this->post(title: 'Penerapan Stack dan Queue',
                    description: '<p>Latihan ini menantang peserta membuat program...</p>',
                    content: '<p>Peserta membuat program untuk menyimulasikan skenario nyata seperti antrian bank...</p>',
                    min_score: 75,
                    type: 'submission'),

                $this->post(title: 'Pengenalan Rekursi',
                    description: '<p>Materi ini menguraikan prinsip dasar rekursi dan contohnya...</p>',
                    content: '<p>Rekursi adalah teknik pemrograman di mana fungsi memanggil dirinya sendiri...</p>',
                    min_score: null,
                    type: 'material'),
                ...
                $this->post(title: 'Tugas Rekursi',
                    ...
                    content: '<p>Implementasikan fungsi rekursif untuk menyelesaikan masalah seperti faktorial, deret Fibonacci...</p>',
                    min_score: 70,
                    type: 'submission'),

                $this->post(title: 'Sorting dan Searching',
                    description: '<p>Menjelaskan berbagai algoritma pengurutan dan pencarian...</p>',
                    content: '<p>Materi mencakup pemahaman dan perbandingan algoritma pengurutan (sorting)...</p>',
                    min_score: null,
                    type: 'material'),
                ...
                $this->post(title: 'Tugas Pengurutan dan Pencarian',
                    ...
                    content: '<p>Peserta mengimplementasikan berbagai algoritma sorting (bubble sort, insertion sort, quicksort)...</p>',
                    min_score: 75,
                    type: 'submission'),
            ]
        );
        ...
        $this->addBatch(
            ...
            posts: [
                ...
                $this->post(
                    title: 'Tugas Membuat API CRUD Produk',
                ...
                $this->post(
                    title: 'Validasi dan Error Handling',
                ...
                $this->post(
                    title: 'Otentikasi Menggunakan Token JWT',
                ...
                $this->post(
                    title: 'Rate Limiting dan API Key',
                ...
                $this->post(
                    title: 'Proyek Mini: API Aplikasi Todo List dengan Login',
        ...
        $this->addBatch(
            ...
            posts: [
                $this->post(
                    title: 'Prinsip Desain UI dan UX',
                ...
                $this->post(
                    title: 'Wireframe dan Prototyping',
                ...
                $this->post(
                    title: 'Tugas Membuat Wireframe Aplikasi Kasir',
                ...
                $this->post(
                    title: 'User Flow dan Information Architecture',
                ...
                $this->post(
                    title: 'Accessibility dan Inclusive Design',
                ...
                $this->post(
                    title: 'Design System dan Komponen UI',
                ...
                $this->post(
                    title: 'Proyek Mini: Desain Aplikasi Booking Hotel',
        ...
        $this->addBatch(
            ...
            posts: [
                $this->post(
                    title: 'Konsep Paralelisme dan Konkurensi',
                ...
                $this->post(
                    title: 'Tugas Implementasi Thread',
                ...
                $this->post(
                    title: 'Race Condition dan Deadlock',
                ...
                $this->post(
                    title: 'Tugas Simulasi Deadlock dan Solusi',
                ...
                $this->post(
                    title: 'Parallel Computing dan Task Pool',
                ...
                $this->post(
                    title: 'Proyek Mini: Multithreaded File Downloader',
        ...
        $this->addBatch(
            ...
            posts: [
                ...
                $this->post(
                    title: 'Proyek Mini: CI/CD Pipeline Sederhana',
